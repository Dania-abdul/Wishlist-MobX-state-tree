...
it("can add new items", () => {
  ...
  // they are a representation of the entire model tree, and they get generated in the background
  // everytime it change it creates a copy
...
it("can add new items - 2", () => {
  ...
  list.items[0].changeName("new Name Changed");
